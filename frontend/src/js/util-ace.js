function enable_viewer(editor, viewer, change_func) {
    let timer = undefined;
    let rows = [];
...
function enable_drawio(editor, elm, url) {
    elm.addEventListener('click', () => {
        ...
        if(!t.match(/^:::\s*drawio$/)) {
            ...
            if(nt.match(/^:::\s*drawio$/)) {
                ...
                // notfind ... create markup
                editor.session.insert(editor.getCursorPosition(), ":::drawio\n\n:::");
                target_line = r + 1;
            }
        } else {
            target_line = r + 1;
...
export { enable_viewer, enable_drawio }